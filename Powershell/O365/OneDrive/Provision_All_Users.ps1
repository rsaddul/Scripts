# This will provision all users with a license

$sharepointURL = "https://instanterlearningtrust-admin.sharepoint.com"
$tenantID = "b542ab2d-9b1b-4a71-a473-ff191a94629e"
