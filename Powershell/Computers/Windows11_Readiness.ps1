<#
Windows 11 Compliant: If a device meets all the specified criteria for storage size, memory, TPM version, CPU details, and Secure Boot status, 
it is marked as "Compliant" in the script. This means that the device satisfies all the requirements set forth by the script for Windows 11 compatibility.

Windows 11 Not Compliant: If a device fails to meet any of the specified criteria, it is marked as "Not compliant" in the script. 
This indicates that the device does not fully meet the requirements for Windows 11 compatibility based on the checks performed by the script.

Windows 11 Capable: This status is assigned to devices that have some but not all of the necessary attributes for Windows 11 compatibility. 
These devices might lack certain hardware features or specifications required for full Windows 11 compatibility, but they might still be able to run Windows 11 
with potential limitations or after certain modifications.

Windows 11 Not Capable: This status is assigned to devices that lack essential attributes or features required for Windows 11 compatibility. 
These devices are deemed unable to run Windows 11 without significant upgrades or changes to meet the specified criteria outlined in the script.
...
$CAPABLE_STRING = "Compliant"
$NOT_CAPABLE_STRING = "Not compliant"
$CAPABLE_CAPS_STRING = "COMPLIANT"
$NOT_CAPABLE_CAPS_STRING = "NOT COMPLIANT"
