...
$SiteURL="https://glfschools.sharepoint.com/sites/RhysTests"
$UserAccount="i:0#.f|membership|j.matthews1@glfschools.org"
...
Try {
    ...
    $Cred= Get-Credential -UserName r.saddul@glfschools.org -Message Password
