...
#Parameters
$SiteURL = "https://glfschools.sharepoint.com/sites/operations"
$FolderSiteRelativeURL = "/sites/operations/central operations documents/annette handover/latest upload"
