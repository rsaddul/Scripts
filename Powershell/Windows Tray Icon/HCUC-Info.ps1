#===================================================================================================
# GLF Info Script Developed by Rhys Saddul - Original script template created by Jai Mehta ©2017
#===================================================================================================
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
    ...
    <Grid Name="grid" Height="350" HorizontalAlignment="Left" VerticalAlignment="Top">
        <Label Name="Title" Content="HCUC IT Support Info" HorizontalAlignment="Left" VerticalAlignment="Top" Width="420" Background="#639ed5" Foreground="White" FontWeight="Bold" FontSize="14.5" Height="29"/>
        <Label Content="Email: ithelpdesk@hcuc.ac.uk   Tel: 0203 519 0171" HorizontalAlignment="Left" Margin="0,29,0,0" VerticalAlignment="Top" Width="420" Background="#639ed5" Foreground="White" FontWeight="Bold" FontSize="12.5" Height="26"/>
        <Label Content="07:30 - 16:00 Monday to Friday" HorizontalAlignment="Left" Margin="0,55,0,0" VerticalAlignment="Top" Width="420" Background="#639ed5" Foreground="White" FontSize="11" Height="25"/>
...
$icon = [System.Drawing.Icon]::ExtractAssociatedIcon("$scriptDir\HCUC-Icon.ico")
...
$notifyicon.Text = "Modulo2 IT Support Info" 
