...
$CSV = "C:\Users\Administrator.KET\Desktop\Scripts\Password_Reset\Bulk_Set_Password.csv"

# Define log file paths
$SuccessfulLog = "C:\Users\Administrator.KET\Desktop\Scripts\Password_Reset\Logs\SuccessfulPasswordChanges.log"
$FailedLog = "C:\Users\Administrator.KET\Desktop\Scripts\Password_Reset\Logs\FailedPasswordChanges.log"

# Initialize counters for successful and failed password changes
$SuccessfulChanges = 0
$FailedChanges = 0

# Load CSV data into an array of objects
